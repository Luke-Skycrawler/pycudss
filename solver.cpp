...
void CUSolver::init() {
    ...
    cudaMalloc((void**)&outers_d, n * sizeof(int));
    ...
    cudaMemcpy(outers_d, outers.data(), n * sizeof(int), cudaMemcpyHostToDevice);
    ...
    cudssMatrixCreateCsr(&A, nrows, ncols, nnz, csrRowPtrC, NULL, csrColIndC, csrValC, CUDA_R_32I, CUDA_R_64F, mtype, mview, base);
}
